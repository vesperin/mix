...
/**
 * Walks the AST nodes of a hierarchical object structure.
 */
public abstract class ASTVisitorWithHierarchicalWalk extends ASTVisitor {
  ...
  // @ASTNode
  @Override public boolean visit(Dimension node) {
    return visit((ASTNode) node);
  }

  // @ASTNode
  @Override public void endVisit(Dimension node) {
    endVisit((ASTNode) node);
  }
  ...
  // @MethodReference
  @Override public void endVisit(CreationReference node) {
  ...
  // @MethodReference
  @Override public void endVisit(SuperMethodReference node) {
    endVisit((MethodReference) node);
  }
  ...
  // @MethodReference
  @Override public void endVisit(TypeMethodReference node) {
    endVisit((MethodReference) node);
  }
  ...
  // @AnnotatableType
  @Override public void endVisit(NameQualifiedType node) {
  ...
  // @Type
  @Override public boolean visit(IntersectionType node) {
    return visit((Type) node);
  }

  // @Type
  @Override public void endVisit(IntersectionType node) {
    endVisit((Type) node);
  }
